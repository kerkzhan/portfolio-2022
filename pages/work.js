            ...
            <div className="kp-layout-work-container">
              <div className="kp-layout-two-column">
                ...
                <div>
                  ...
                  <p>
                    The main website contains many hero images and big visuals,
                    so optimizing the images with modern file formats was a
                    priority to drive customers to check the physical location
                    out. I utilized the <code>gatsby-plugin-image</code> to help
                    with this. The plugin contains controls for lazy loading, as
                    well as responsive images.
                  </p>
              ...
              <div className="kp-layout-two-column">
                ...
                <div>
                  ...
                  <p className="kp-stack-32">
                    ...
                    project from a client all by myself. This was the biggest
                    task I've taken on at the time as an intern and I learnt a
                    lot from leading this project.
                  </p>
                  <p className="kp-stack-32">
                  ...
                  <p>
                    With this project, I learnt how to request, post and
                    aggregate data from a NOSQL database such as{" "}
                    <code>MongoDB</code> and tie it all together.
                  </p>
                  <SkillNodes
                    skills={[
                      "React Admin",
              ...
              <div className="kp-layout-two-column">
                ...
                <div>
                  ...
                  <p>
                    ...
                    showcased game. You could click on an image and it would
                    lead to a server-side generated website based on the{" "}
              ...
              <div className="kp-layout-two-column">
                ...
                <div>
                  ...
                  <p className="kp-stack-32">
                    ...
                    well as create a community of mouse enthusiasts and modders
                    in Malaysia.
                  </p>

                  <p>
                    Right now, I maintain 2 Facebook pages with over 8000
                    members as an admin ensuring high quality discussions. I'm
                    glad my hobbies and interests can help increase general
                    public's knowledge about Right to Repair. If you have an
                    interest to collaborate about gaming mice, contact me!
                  </p>
                </div>
              </div>
            </div>
